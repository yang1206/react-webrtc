...
export function Providers(props: PropsWithChildren) {
  return (
    <ProviderComposer contexts={useRefValue(() => [<JotaiStoreProvider key="JotaiStoreProvider" />, <DarkModeProvider key="DarkModeProvider" />, <ReactQueryProvider key="react-query" />, <AppRouterProvider key="router" />])}>
      {props.children}
    </ProviderComposer>
  )
}
